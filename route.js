...
let id=hall_ids.length+1;
hall_ids.push({
  hall_id: id,
    available_now:req.body.available_now,
    hall_size: req.body.hall_size,
    stage_size: req.body.stage_size,
    seats: req.body.seats,
    price_per_hour:req.body.price_per_hour,
    Address: req.body.Address,
});
console.log(hall_ids);
res.status(200).send(your Hall id--- ${id});
})

// 2. hall booking with user
router.post("/:username/bookhall/:hall_id", async (req, res) => {
...
router.delete("/:username/cancelhall/:booking_id", async (req, res) => {
